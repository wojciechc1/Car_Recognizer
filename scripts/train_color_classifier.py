...
def train_color_classifier():
    ...
    # Dataset
    train_dataset = datasets.ImageFolder(root='../../Datasets/data/colors_ds/train', transform=train_transform)
    test_dataset = datasets.ImageFolder(root='../../Datasets/data/colors_ds/test', transform=val_transform)
    ...
    torch.save(model.state_dict(), "../config/color_classifier.pth")
